...
#pragma warning disable IDE1006
    internal sealed class MaterialButtonClickEvent
    {
        ...
        internal static void onClickAdd(Material m)
        {
            ...
            {
                Program.logger.Log(Level.ERROR, nameof(onClickAdd), nameof(MaterialStartupEvent) + "/" + e1.GetType().Name, e1.Message);
                database.DisconnectDatabase();
        ...
        internal static void onClickDelete(Material m)
        {
            ...
            {
                Program.logger.Log(Level.ERROR, nameof(onClickDelete), nameof(MaterialStartupEvent) + "/" + e1.GetType().Name, e1.Message);
                database.DisconnectDatabase();
            }
        }
        ...
        internal static void onClickSave(Material m)
        {
            ...
            {
                Program.logger.Log(Level.ERROR, nameof(onClickSave), nameof(MaterialStartupEvent) + "/" + e1.GetType().Name, e1.Message);
                database.DisconnectDatabase();
            }
        }
